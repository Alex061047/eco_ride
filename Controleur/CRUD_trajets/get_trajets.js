// On récupère le rôle utilisateur pour gérer l'affichage des onglets
fetch("../../Controleur_b/CRUD_vehicule/get_user_controller.php")
...
// Gestion des trajets
fetch("../../Controleur_b/CRUD_trajets/get_trajets_controller.php")
    .then(response => response.json())
    .then(data => {
...
function annulerTrajet(trajetId) {
    if (confirm("Voulez-vous vraiment annuler ce trajet ?")) {
        fetch("../../Controleur_b/CRUD_trajets/update_trajet_controller.php", {
            method: "POST",
...
function annulerReservation(trajetId) {
    if (confirm("Voulez-vous vraiment annuler votre réservation ?")) {
        fetch("../../Controleur_b/CRUD_trajets/annuler_reservation_controller.php", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
