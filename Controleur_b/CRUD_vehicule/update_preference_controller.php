<?php
// Mise a jour preferences: utilisateur connecte, id protege.
...
if ($userRole !== 'admin' && $targetId !== $userId) {
    securityAbort(403, 'Modification preferences interdite pour un autre utilisateur.');
}

require_once __DIR__ . '/../../Modele/CRUD_vehicule/update_preference.php';
